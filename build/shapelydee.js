...
/*! Shapelydee 0.0.2 //// MIT Licence //// http://shapelydee.loop.coop/ */
(function(global) {
...
Shape = (function() {
  ...
  Shape.prototype.xx = function(yy) {
    var M;
...
ShapelyDee = (function() {
  ...
  ShapelyDee.prototype.add = function(config) {
    ...
    if ('cube' === a) {
      return this[oo._]._shapes.push(new Shape({
        origin: config.origin,
        scale: config.scale,
        rotation: config.rotation,
        color: config.color,
...
Shape.Cube = (function(superClass) {
  ...
  Cube.prototype.xx = function(yy) {
    var M;
    M = '/shapelydee/src/Shape/Cube.litcoffee Shape::xx()\n  ';
    return yy = oo.vArg(M, yy, 'yy <number>', 123);
  };
