...
/*! Shapelydee 0.0.1 //// MIT Licence //// http://shapelydee.loop.coop/ */
(function(global) {
...
/*! Shapelydee 0.0.1 */
var ShapelyDee, SomeClass, Tudor, tudor, x, xx,
...
ShapelyDee = (function() {
  ...
  ShapelyDee.prototype.xx = function(yy) {
    var M;
...
SomeClass = (function() {
  ...
  function SomeClass(config) {
    ...
    M = '/shapelydee/src/SomeClass.litcoffee SomeClass()\n  ';
    v = oo.vObject(M, 'config', config);
    this.x = v('x <number>', 123);
    oo.define(this, oo._, {}, 'private');
    this[oo._]._x = null;
  ...
  SomeClass.prototype.xx = function(yy) {
    var M;
    M = '/shapelydee/src/SomeClass.litcoffee SomeClass::xx()\n  ';
    return yy = oo.vArg(M, yy, 'yy <number>', 123);
  };
...
SomeClass.FirstSubClass = (function(superClass) {
  ...
  function FirstSubClass(config) {
    ...
    M = '/shapelydee/src/SomeClass/FirstSubClass.litcoffee SomeClass.FirstSubClass()\n  ';
  ...
  FirstSubClass.prototype.xx = function(yy) {
    var M;
    M = '/shapelydee/src/SomeClass/FirstSubClass.litcoffee SomeClass::xx()\n  ';
    return yy = oo.vArg(M, yy, 'yy <number>', 123);
  };
...
SomeClass.FirstSubClass.xx = function(yy) {
  var M;
  M = '/shapelydee/src/SomeClass/FirstSubClass.litcoffee SomeClass.FirstSubClass.xx()\n  ';
  return yy = oo.vArg(M, yy, 'yy <number>', 123);
};
...
SomeClass.SecondSubClass = (function(superClass) {
  ...
  function SecondSubClass(config) {
    ...
    M = '/shapelydee/src/SomeClass/SecondSubClass.litcoffee SomeClass.SecondSubClass()\n  ';
  ...
  SecondSubClass.prototype.xx = function(yy) {
    var M;
    M = '/shapelydee/src/SomeClass/SecondSubClass.litcoffee SomeClass::xx()\n  ';
    return yy = oo.vArg(M, yy, 'yy <number>', 123);
  };
...
SomeClass.SecondSubClass.xx = function(yy) {
  var M;
  M = '/shapelydee/src/SomeClass/SecondSubClass.litcoffee SomeClass.SecondSubClass.xx()\n  ';
  return yy = oo.vArg(M, yy, 'yy <number>', 123);
};
...
tudor.add([
  "01 ShapelyDee Constructor", tudor.is, "The class and instance are expected types", function() {
    ...
    return shapelydee.x;
  }, "`ShapelyDee::_x` is private, and is null", null, function(shapelydee) {
    return shapelydee[oo._]._x;
  }
]);
